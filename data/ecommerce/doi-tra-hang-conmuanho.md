...
b. Sau thời gian mười lăm (15) ngày kể từ ngày mua hàng, Cơn Mưa Nhỏ sẽ không đồng ý nhận hàng trả lại.

c. Giá trị trả hàng không vượt quá 10% giá trị đơn hàng.
...
b. Sau thời gian mười lăm (15) ngày kể từ ngày mua hàng, Cơn Mưa Nhỏ sẽ không đồng ý nhận đổi hàng.

c. Giá trị sản phẩm đổi phải ngang bằng hoặc cao hơn giá trị sản phẩm đã mua trước đó. Trường hợp sản phẩm đổi đã hết tồn kho hoặc bị bỏ mẫu, Khách hàng được đổi sang sản phẩm khác có giá trị tương đương hoặc sản phẩm giá tri cao hơn và bù thêm khoản tiền chêch lệch.

d. Trong trường hợp khách hàng đặt cọc để giữ hàng, nếu có phát sinh thay đổi danh mục hàng hóa giao hàng sẽ được hỗ trợ xử lý tùy theo từng trường hợp cụ thể.
...
a. Không có dấu hiệu đã qua sử dụng, còn nguyên hộp, bao bì nhà sản xuất;

b. ​​​​​​Không bị lỗi về hình thức (trầy, xước, móp méo, ố vàng, vỡ và hỏng hóc...);

c. Đầy đủ bao bì, thùng, hộp, và phụ kiện đi kèm và quà tặng kèm theo (nếu có);

d. Có đầy đủ các chứng từ kèm theo, ví dụ như biên bản giao hàng, phiếu bảo hành (nếu có);

e. Đối với Khách hàng cá nhân: Cơn Mưa Nhỏ sẽ thu hồi lại hóa đơn VAT đã xuất lúc bán cho Khách hàng (1 hóa đơn chỉ được đổi trả 1 lần);

f. Đối với Khách hàng là công ty: Khách hàng sẽ xuất cho Cơn Mưa Nhỏ hóa đơn hàng bán trả lại, tương ứng với số lượng cần trả lại.

Khi đủ các điều kiện trên, Cơn Mưa Nhỏ sẽ tiến hành đổi, trả lại sản phẩm mới cho Khách hàng. Khách hàng sẽ chịu toàn bộ chi phí vận chuyển phát sinh khi đổi, trả hàng.
...
​​​​​​​a. Bước 1: Khách hàng liên hệ với Hotline hoặc nhân viên bán hàng, cung cấp thông tin chi tiết về sản phẩm đề nghị đổi trả, bao gồm: mã số đơn hàng, tên sản phẩm, lỗi sản phẩm (Mô tả chi tiết và gửi thêm ảnh chụp qua Zalo/Facebook/email… nếu được yêu cầu), nhu cầu cần hỗ trợ.

b. Bước 2: Cơn Mưa Nhỏ sẽ tiến hành kiểm tra và xác minh thông tin yêu cầu đổi trả.

c. Bước 3: Sau khi đã xác minh thông tin và đồng ý đổi trả hàng, Cơn Mưa Nhỏ sẽ gửi thông tin yêu cầu đổi trả đến nhân viên bán hàng hoặc đối tác Cơn Mưa Nhỏ (theo thời gian quy định cụ thể tùy theo mô hình hợp tác).

d. Bước 4: Nhân viên bán hàng/đối tác Cơn Mưa Nhỏ xác nhận thông tin yêu cầu đổi trả và chỉ định địa điểm nhận hàng đổi trả.
...
b. Đối với đơn hàng đã được thanh toán bằng tiền mặt: Cơn Mưa Nhỏ tiến hành hoàn tiền theo phương thức chuyển khoản sau khi nhận được sản phẩm trả về của Khách hàng và thông tin về tài khoản ngân hàng mà Khách hàng mong muốn được nhận chuyển khoản, chậm nhất là ba mươi (30) ngày kể từ khi nhận được đầy đủ hàng hóa và thông tin hợp lệ từ Khách hàng.

c. Với đơn hàng đã được thanh toán bằng chuyển khoản trước khi giao hàng: Cơn Mưa Nhỏ sẽ hoàn tiền vào tài khoản mà Khách hàng đã sử dụng khi thanh toán, chậm nhất là ba mươi (30) ngày kể từ ngày nhận được đầy đủ sản phẩm trả về của Khách hàng.
